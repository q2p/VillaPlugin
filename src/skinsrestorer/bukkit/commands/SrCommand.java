...
public class SrCommand implements org.bukkit.command.CommandExecutor
{
  public SrCommand() {}
    ...
    if (sender.hasPermission("skinsrestorer.cmds"))
    {
      ...
      } else if ((args.length > 0) && (args[0].equalsIgnoreCase("props")))
      {
        ...
        try {
          ...
          Collection<?> props = (Collection)ReflectionUtil.invokeMethod(propmap.getClass(), propmap, "get", new Class[] { Object.class }, new Object[] { "textures" });
          ...
          for (Object prop : props)
          {
            ...
            String decoded = org.yaml.snakeyaml.external.biz.base64Coder.Base64Coder.decodeString(value);
  ...
  public void reloadConfig(CommandSender sender, String msg) {
    ...
    sender.sendMessage(skinsrestorer.shared.utils.C.c(msg));
  }
}
