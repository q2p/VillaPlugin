  ...
  public void execute(final CommandSender sender, String[] args)
  {
    if (sender.hasPermission("skinsrestorer.cmds"))
    {
      ...
      else
      {
        ...
        if ((args.length >= 2) && (args[0].equalsIgnoreCase("defaultSkins"))) {
          ...
          return; }
        if ((args.length >= 2) && (args[0].equalsIgnoreCase("disabledSkins"))) {
          if (args[1].equalsIgnoreCase("true")) {
        ...
        if ((args.length == 2) && (args[0].equalsIgnoreCase("joinSkins"))) {
          if (args[1].equalsIgnoreCase("true")) {
          ...
          return; }
        if ((args.length == 2) && (args[0].equalsIgnoreCase("updater"))) {
          if (args[1].equalsIgnoreCase("true")) {
          ...
          return; }
        if ((args.length == 2) && (args[0].equalsIgnoreCase("skinwithoutperm"))) {
          if (args[1].equalsIgnoreCase("true")) {
          ...
          return; }
        if ((args.length == 2) && (args[0].equalsIgnoreCase("skinCooldown"))) {
          if (isStringInt(args[1])) {
            Config.SKIN_CHANGE_COOLDOWN = Integer.valueOf(args[1]).intValue();
          ...
          return; }
        if ((args.length == 2) && (args[0].equalsIgnoreCase("SkinExpiresAfter"))) {
          if (isStringInt(args[1])) {
            Config.SKIN_EXPIRES_AFTER = Integer.valueOf(args[1]).intValue();
        ...
        if ((args.length > 0) && (args[0].equalsIgnoreCase("props")))
        {
    ...
    } else { sender.sendMessage(Locale.PLAYER_HAS_NO_PERMISSION);
      return;
    }
  }
