...
public class ProxyManager
{
  ...
  public static List<String> getList() { if (proxies.isEmpty()) {
  ...
  public static List<String> updateProxies() { proxies = new ArrayList();
  ...
  private static List<String> readURL(String url) throws IOException {
    try {
      ...
      BufferedReader in = new BufferedReader(new java.io.InputStreamReader(con.getInputStream(), Charset.forName("UTF-8")));
      String str = "";
      int limit = 5;
      while ((ProxyManager.inputLine = in.readLine()) != null) {
        str = inputLine;
      }
